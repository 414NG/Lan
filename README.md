...
<head>
  ...
  <title>Mi comunidad: Ciudad Serdá</title>
  <style>
    body {
      background-color: lightblue;
      margin: 30px;
      border: 15px solid #a5d6a7;
      padding: 20px;
      border-radius: 20px;
      font-family: Arial;
    }
    .contenedor {
      border: 5px dashed #c8e6c9;
      padding: 15px;
      border-radius: 10px;
      text-align: center;
    }
...
<body>
  <div class="contenedor">
    <h1>Bienvenidos a Ciudad Serdán</h1>
    ...
    <img src="https://fundacionpanama.org/wp-content/uploads/2020/09/fundacion-panama.jpg" width="300" height="200" alt="Ciudad Serdán" />
    ...
    <img src="https://cdn.pixabay.com/photo/2022/05/17/13/42/volcano-7201963_960_720.png" width="300" alt="Volcán" />
    <h2>Las 7 R’s del reciclaje</h2>
    ...
    <br><br>
    <img src="https://cdn.pixabay.com/photo/2021/06/28/15/16/community-6370681_960_720.png" width="300" alt="Comunidad" />
    <h2>Comparación de las 7 R’s</h2>
    <table border="1">
    ...
    <h2 style="font-family: Impact;">Actividades comunitarias</h2>
    <p>Estas son algunas acciones realizadas:</p>
    <table border="1" class="tabla-actividades">
      <tr>
        <th>Actividad</th>
        <th>Fecha</th>
        <th>Lugar</th>
    ...
    <br>
    <img src="https://cdn.pixabay.com/photo/2020/05/08/08/53/recycling-5147095_960_720.png" width="300" alt="Reciclaje" />
    <h2>Contacto</h2>
    <p class="contacto"><strong>Correo:</strong> alangarcias6--13@dgb.edu.mx</p>
  </div>
</body>
</html>
